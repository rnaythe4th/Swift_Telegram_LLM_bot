...
### 10.5. Durability как условие продажи
...
- Хранилище: **`DATABASE_URL`** —
  ...
  memory-only **и ничего не продаёт** (§10.5). Обязательно **session**-режим
...
- **Новый вход в кассу проверяет `StateDurability`** (§10.5). Продажа из
