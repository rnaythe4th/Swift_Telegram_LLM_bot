...
`swift test` — цель `LLM_chat_botTests`, 572 теста в 60 классах; 551 без сети
...
переезд/reset/forget, round-trip строки, пред-буфер: подхват при включении,
не дважды, не поверх стёртого, границы по времени и по числу чатов),
